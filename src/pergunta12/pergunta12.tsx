  ...
  return (
    <div className="borda">
      <div className="quadrado">
        <h4>
          12. A documentação específica geralmente utilizada em algumas redes
          sociais para comprovar o falecimento de usuários é:{" "}
        </h4>
      </div>
